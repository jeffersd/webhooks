...
test("should return a 400 for POSTing invalid Json to /webhook", () => {
    const hashedBody = "sha256=1b2c16b75bd2a870c114153ccda5bcfca63314bc722fa160d690de133ccbb9db";
...
test("should return a 200 for a POST to /webhook", () => {
    const hashedBody = "sha256=f5345e764d0dd7c6553bb7a6580d7f67777b03ed1ef5b8d0a7455fc006c5c7be";
...
test("should return a 401 if the secret was invalid", () => {
    const hashedBody = "sha256=cab4ba4116de8c5f0d9c518e6135b76caebeab057f13c2274f0081380108a4fd";
...
test("should return a 401 if the data was invalid", () => {
    const hashedBody = "sha256=bdb37a869e95710324a5f884f6e5e678f496d738f955fc048e33bbf1992ebf37";
